...
public class Suspect {
    ...
    public Suspect(String name, boolean alibi, int aggressiveness, int criminalRecordsNumber,
        ...
        if(aggressiveness < 0 || aggressiveness > 10) throw new IllegalArgumentException("Aggressive value should be from 0 to 10");
        if(criminalRecordsNumber < 0) throw new IllegalArgumentException("Number of criminal records should be from 0");
        this.name = name;
        this.alibi = alibi;
